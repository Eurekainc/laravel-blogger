<div class='add_comment_area'>
    ...
    <form method='post' action='{{route("hessam.comments.add_new_comment", $post->slug)}}'>
        @csrf
        ...
        <div class='container-fluid'>
            <div class='row'>
                ...
                @if(config("hessam.comments.save_user_id_if_logged_in", true) == false || !\Auth::check())
                    ...
                    @if(config("hessam.comments.ask_for_author_email"))
                        <div class='col'>
                            <div class="form-group">
