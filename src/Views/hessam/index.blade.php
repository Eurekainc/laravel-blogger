...
@section("content")
    ...
    <div class='row'>
        <div class='col-sm-12 hessam_container'>
            @if(\Auth::check() && \Auth::user()->canManageHessamPosts())
            ...
            @endif
                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        @if(isset($hessam_category) && $hessam_category)
                            <h2 class='text-center'> {{$hessam_category->category_name}}</h2>

                            @if($hessam_category->category_description)
                                <p class='text-center'>{{$hessam_category->category_description}}</p>
                            @endif
                        ...
                        <div class="container">
                            <div class="row">
                                @forelse($posts as $post)
                                    @include("hessam::partials.index_loop")
                                @empty
