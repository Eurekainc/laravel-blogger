...
<head>
    ...
    <!-- Styles -->
    @if(file_exists(public_path("hessam_admin_css.css")))
        <link href="{{ asset('hessam_admin_css.css') }}" rel="stylesheet">
    @else
...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container">
            <a class="navbar-brand hessam-blog-title" href="{{ route('hessam.admin.index') }}">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class='nav-item px-2'><a class='nav-link' href='{{route("hessam.index")}}'>Blog home</a></li>
        ...
        <div class="container">
            <div class='row full-width-div'>
                <div class='col-md-3 list-group-color'>
                    @include("hessam_admin::layouts.sidebar")
                ...
                <div class='col-md-9 main-content'>
                    ...
                    @if(\HessamDev\Hessam\Helpers::has_flashed_message())
                        <div class='alert alert-info'>
                            <h3>{{\HessamDev\Hessam\Helpers::pull_flashed_message() }}</h3>
                        </div>
                    @endif
...
@if( config("hessam.use_wysiwyg") && config("hessam.echo_html") && (in_array( \Request::route()->getName() ,[ 'hessam.admin.create_post' , 'hessam.admin.edit_post'  ])))
