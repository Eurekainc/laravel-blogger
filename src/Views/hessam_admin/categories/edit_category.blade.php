...
@section("content")
    ...
    <form method='post' action='{{route("hessam.admin.categories.edit_category",$category->id)}}'  enctype="multipart/form-data" >
...
//        alert("A");
        ...
        <div class="form-group">
            ...
            <small id="category_slug_help" class="form-text text-muted">
                ...
                i.e. {{route("hessam.view_category","")}}/<u><em>this_part</em></u>. This must be unique (two categories can't
                share the same slug).
