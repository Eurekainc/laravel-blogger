...
@section("content")
    ...
    <form method='post' action='{{route("hessam.admin.images.store")}}' enctype="multipart/form-data">
        ...
        <div class="form-group mb-4 p-2">
            ...
            <div>
                <input type='checkbox' name='sizes_to_upload[hessam_full_size]' value='true' checked id='size_hessam_full_size'>
            <label for='size_hessam_full_size'>Full size (no resizing)</label>
                </div>
