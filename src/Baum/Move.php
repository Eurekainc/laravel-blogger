...
class Move {
  ...
  * Destination node
  *
  * @var \HessamDev\Hessam\Baum\Node | int
  */
  ...
  */
   ...
   * @param   \HessamDev\Hessam\Baum\Node|int  $target
   ...
   * @param   \HessamDev\Hessam\Baum\Node|int  $target
   * @param   string          $position
   * @return \HessamDev\Hessam\Baum\Node
   */
   ...
   * supplied parameter is an instance of \HessamDev\Hessam\Baum\Node. Otherwise it will try
   * to find the node in the database.
   *
   * @param   \HessamDev\Hessam\Baum\node|int
   * @return  \HessamDev\Hessam\Baum\Node
   */
  protected function resolveNode($node) {
    if ( $node instanceof \HessamDev\Hessam\Baum\Node ) return $node->reload();
