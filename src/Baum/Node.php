...
use HessamDev\Hessam\Baum\Extensions\Eloquent\Collection;
use HessamDev\Hessam\Baum\Extensions\Eloquent\Model;
...
abstract class Node extends Model {
  ...
  */
   ...
   *
   * @param array $models
   * @return \HessamDev\Hessam\Baum\Extensions\Eloquent\Collection
   */
  ...
  */
   ...
   * Equals?
   *
   * @param \HessamDev\Hessam\Baum\Node
   * @return boolean
   */
