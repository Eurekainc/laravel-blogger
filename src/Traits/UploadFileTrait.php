...
namespace HessamDev\Hessam\Traits;

use Illuminate\Http\UploadedFile;
use HessamDev\Hessam\Events\UploadedImage;
...
trait UploadFileTrait
{
     ...
     * This can be defined in the config file. If hessam.memory_limit is false/null then it won't do anything.
    ...
    protected function UploadAndResize(HessamPost $new_blog_post = null, $suggested_title, $image_size_details, $photo)
    {
        ...
        // save image
        $resizedImage->save($destinationPath . '/' . $image_filename, config("hessam.image_quality", 80));
