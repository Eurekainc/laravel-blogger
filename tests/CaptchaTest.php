    ...
    public function testRuleCustomValidationFunctionReturnsCorrectly()
    {
        ...
        foreach ($captcha->rules() as $rule) {
            ...
            if (is_callable($rule)) {
                ...
                \Config::set('hessam.captcha.basic_answers', "ignoreme,dark,ignoreme2");
                ...
                \Config::set('hessam.captcha.basic_answers', "bLAcK");
                ...
                // testing CORRECT answer
                \Config::set('hessam.captcha.basic_answers', "ignoreme, BLACK , jgnoreme2");
                $this->assertNull($rule('wrong1', ' black', function () {
                    return "lookingforthis";
                }));
            }
